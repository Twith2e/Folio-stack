...
//         {work.length > 0 && (
//           <div>
//             <h2 className="text-xl lg:text-3xl font-medium lg:font-bold text-center mb-3 mt-12">
//               Work Experience
//             </h2>
...
//                           item.logo !== ""
//                             ? item.logo
//                             : "https://placehold.co/200x60.svg?text=Logo"
//                         }
//                         alt={item.company}
//                         width={50}
//                         height={50}
...
//                     {item.startDate && (
//                       <span>
//                         <span>{item.startDate}</span> {item.endDate && "-"}{" "}
//                         {item.endDate}
//                       </span>
//                     )}
//                   </div>
